...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dsto_medicamentos_rubrica'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dsto_medicamentos_rubrica : UserControl
    {
...
""".Trim();
        ...
        /// <summary>
        /// (PowerBuilder) arguments = (("capitulo", string)
        /// </summary>
        public static readonly string OriginalArguments = @"(""capitulo"", string";
        ...
        public dsto_medicamentos_rubrica()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dsto_medicamentos_rubrica");
            da.Fill(dt);
