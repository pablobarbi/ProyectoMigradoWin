...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dk_repertos_parciales_v1'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dk_repertos_parciales_v1 : UserControl
    {
...
""".Trim();
        ...
        public dk_repertos_parciales_v1()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dk_repertos_parciales_v1");
            da.Fill(dt);
