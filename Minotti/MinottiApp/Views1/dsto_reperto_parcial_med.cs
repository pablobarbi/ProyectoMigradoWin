...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dsto_reperto_parcial_med'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dsto_reperto_parcial_med : UserControl
    {
...
""".Trim();
        ...
        public dsto_reperto_parcial_med()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dsto_reperto_parcial_med");
            da.Fill(dt);
