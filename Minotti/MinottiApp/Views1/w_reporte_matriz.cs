...
namespace Minotti
{
    ...
    public partial class w_reporte_matriz : Form
    {
...
﻿forward
global type w_reporte_matriz from w_reporte
end type
end forward
...
global w_reporte_matriz w_reporte_matriz

on w_reporte_matriz.create
call super::create
end on

on w_reporte_matriz.destroy
call super::destroy
end on
...
if rtn = 1 then
	filtro = parametros[1]
	if (len(filtro) < 3) OR isnull(filtro) then
		MessageBox('Atención', 'Debe ingresar al menos 3 letras como filtro.')
		dw_param.SetFocus()
	else 
...
﻿<pbwpf:Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"  xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"  xmlns:pbwpf="clr-namespace:Sybase.PowerBuilder.WPF.Controls;assembly=Sybase.PowerBuilder.WPF.Controls"  x:Class="w_reporte_matriz" x:ClassModifier="internal">
	<Canvas>
	</Canvas>
</pbwpf:Window>
