...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dk_repertos_totales_sintomas'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dk_repertos_totales_sintomas : UserControl
    {
...
""".Trim();
        ...
        public dk_repertos_totales_sintomas()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dk_repertos_totales_sintomas");
            da.Fill(dt);
