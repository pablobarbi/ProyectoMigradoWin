...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dsto_reperto_total'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dsto_reperto_total : UserControl
    {
...
""".Trim();
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dsto_reperto_total");
            da.Fill(dt);
