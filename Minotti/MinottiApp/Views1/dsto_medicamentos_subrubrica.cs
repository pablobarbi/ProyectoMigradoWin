...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dsto_medicamentos_subrubrica'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dsto_medicamentos_subrubrica : UserControl
    {
...
""".Trim();
        ...
        /// <summary>
        /// (PowerBuilder) arguments = (("rubrica", string)
        /// </summary>
        public static readonly string OriginalArguments = @"(""rubrica"", string";
        ...
        public dsto_medicamentos_subrubrica()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dsto_medicamentos_subrubrica");
            da.Fill(dt);
