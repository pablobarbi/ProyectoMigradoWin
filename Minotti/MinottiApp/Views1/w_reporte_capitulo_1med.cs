...
namespace Minotti
{
    ...
    public partial class w_reporte_capitulo_1med : Form
    {
...
﻿forward
global type w_reporte_capitulo_1med from w_reporte
end type
end forward
...
global w_reporte_capitulo_1med w_reporte_capitulo_1med
...
on w_reporte_capitulo_1med.create
call super::create
end on

on w_reporte_capitulo_1med.destroy
call super::destroy
end on
...
﻿<pbwpf:Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"  xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"  xmlns:pbwpf="clr-namespace:Sybase.PowerBuilder.WPF.Controls;assembly=Sybase.PowerBuilder.WPF.Controls"  x:Class="w_reporte_capitulo_1med" x:ClassModifier="internal">
	<Canvas>
	</Canvas>
</pbwpf:Window>
