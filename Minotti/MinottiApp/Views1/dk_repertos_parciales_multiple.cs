...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dk_repertos_parciales_multiple'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dk_repertos_parciales_multiple : UserControl
    {
...
""".Trim();
        ...
        /// <summary>
        /// (PowerBuilder) arguments = (("repertos", string)
        /// </summary>
        public static readonly string OriginalArguments = @"((""repertos"", string)";
        ...
        public dk_repertos_parciales_multiple()
        {
            InitializeComponent();
        }
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dk_repertos_parciales_multiple");
            da.Fill(dt);
