...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dsto_reperto_temporal'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dsto_reperto_temporal : UserControl
    {
...
""".Trim();
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dsto_reperto_temporal");
            da.Fill(dt);
