...
namespace Minotti
{
    // Migrado desde PowerBuilder Window: w_reporte_capitulo_1med_valor.srw
    // Se conserva el nombre exacto y se adjunta el contenido original como comentario.
    public partial class w_reporte_capitulo_1med_valor : Form
    {
        public w_reporte_capitulo_1med_valor()
        {
            InitializeComponent();
        }
...
﻿forward
global type w_reporte_capitulo_1med_valor from w_reporte
end type
end forward
...
global w_reporte_capitulo_1med_valor w_reporte_capitulo_1med_valor
...
on w_reporte_capitulo_1med_valor.create
call super::create
end on

on w_reporte_capitulo_1med_valor.destroy
call super::destroy
end on
...
IF IsNull(ll_capitulo) OR IsNull(ls_medicamento) OR IsNull(ll_valor) THEN
...
﻿<pbwpf:Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"  xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"  xmlns:pbwpf="clr-namespace:Sybase.PowerBuilder.WPF.Controls;assembly=Sybase.PowerBuilder.WPF.Controls"  x:Class="w_reporte_capitulo_1med_valor" x:ClassModifier="internal">
	<Canvas>
	</Canvas>
</pbwpf:Window>
