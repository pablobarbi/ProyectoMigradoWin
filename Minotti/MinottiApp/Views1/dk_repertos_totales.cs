...
{
    /// <summary>
    /// WinForms UserControl migrado desde DataWindow 'dk_repertos_totales'.
    /// Mantiene nombres y SQL original. Conecta via ODBC (SQL Anywhere 9) usando DSN.
    /// </summary>
    public partial class dk_repertos_totales : UserControl
    {
...
""".Trim();
        ...
        public void Retrieve(params object[] args)
        {
            ...
            var dt = new DataTable("dk_repertos_totales");
            da.Fill(dt);
