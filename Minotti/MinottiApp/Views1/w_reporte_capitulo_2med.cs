...
namespace Minotti
{
    ...
    public partial class w_reporte_capitulo_2med : Form
    {
...
﻿forward
global type w_reporte_capitulo_2med from w_reporte
end type
end forward
...
global w_reporte_capitulo_2med w_reporte_capitulo_2med
...
on w_reporte_capitulo_2med.create
call super::create
end on

on w_reporte_capitulo_2med.destroy
call super::destroy
end on
...
﻿<pbwpf:Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"  xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"  xmlns:pbwpf="clr-namespace:Sybase.PowerBuilder.WPF.Controls;assembly=Sybase.PowerBuilder.WPF.Controls"  x:Class="w_reporte_capitulo_2med" x:ClassModifier="internal">
	<Canvas>
	</Canvas>
</pbwpf:Window>
