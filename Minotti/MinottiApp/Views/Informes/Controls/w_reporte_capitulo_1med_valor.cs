...
namespace Minotti.Views.Informes.Controls
{
    ...
    public partial class w_reporte_capitulo_1med_valor : w_reporte
    {
        // PB: uo_ds ds_reporte
        ...
        public override void ue_procesar()
        {
            ...
            try
            {
                ...
                ll_valor = (long)dw_param.GetItemNumber(1, "valor");

                // IF IsNull(ll_capitulo) OR IsNull(ls_medicamento) OR IsNull(ll_valor) THEN ...
                // (En PB los Long pueden ser null; en C# long no, así que chequeo null del campo en DW)
                if (dw_param.IsNull(1, "capitulo") || ls_medicamento == null || dw_param.IsNull(1, "valor"))
                {
                    MessageBox.Show(
                ...
                ls_capitulos.uo_devolver_un_med_valor(ref ds_reporte, ls_medicamento, (int)ll_valor);
