...
namespace Minotti.Views.Informes.Controls
{
    ...
    public partial class w_reporte_capitulo_2med_valor : w_reporte
    {
        // PB: uo_ds ds_reporte
        ...
        public override void ue_procesar()
        {
            ...
            try
            {
                ...
                ll_valor2 = (long)dw_param.GetItemNumber(1, "valor2");

                // IF IsNull(...) THEN ...
                if (dw_param.IsNull(1, "capitulo") ||
                    ls_medicamento == null ||
                    ls_medicamento2 == null ||
                    dw_param.IsNull(1, "valor") ||
                    dw_param.IsNull(1, "valor2"))
                {
                    MessageBox.Show(
                ...
                ls_capitulos.uo_devolver_un_med_valor(ref ds_reporte, ls_medicamento2, (int)ll_valor2);
