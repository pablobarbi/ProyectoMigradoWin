...
{
    /// <summary>
    /// Migrado desde PB Window 'w_reperto_subrubricas_ph' (deriva de w_abm_lista_seleccion).
    /// Se preservan nombres y se integra el patrón visible de rollback (sin inventar SQL adicional).
    /// </summary>
    public partial class w_reperto_subrubricas_ph : w_operacion
    {
        public w_reperto_subrubricas_ph()
        {
            InitializeComponent();
        }
        ...
        public override void ue_leer_parametros()
        {
            ...
            /*
             * DataObject según w_reperto_subrubricas_ph.srw
             */
            dw_1.uof_setdataobject("dk_reperto_subrubricas_ph");
