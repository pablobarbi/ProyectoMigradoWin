...
ORDER BY 5";
        ...
        public string SrdRaw => @"$PBExportHeader$dk_subrubricas_de_la_subrubrica.srd
release 10.5;
...
table(column=(type=decimal(0) update=yes updatewhereclause=yes key=yes name=subrubrica_padre dbname=""subrubricaciones.subrubrica_padre"" )
 column=(type=decimal(0) update=yes updatewhereclause=yes key=yes name=subrubrica_hija dbname=""subrubricaciones.subrubrica_hija"" )
 column=(type=char(255) updatewhereclause=yes name=subrubricas_nombre dbname=""subrubricas.nombre"" )
 column=(type=long update=yes updatewhereclause=yes name=posicion dbname=""subrubricaciones.posicion"" )
...
END as subrubricas_nombre_orden
 ...
 WHERE subrubricaciones.subrubrica_hija = subrubricas.subrubrica
   AND subrubricaciones.subrubrica_padre = :subrubrica
ORDER BY 5
"" update=""subrubricaciones"" updatewhere=0 updatekeyinplace=no arguments=((""subrubrica"", string)) )
...
column(band=detail id=3 alignment=""0"" tabsequence=32766 border=""0"" color=""0"" x=""18"" y=""4"" height=""76"" width=""2770"" format=""[general]"" html.valueishtml=""0""  name=subrubricas_nombre visible=""1"" editmask.mask=""!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"" editmask.focusrectangle=no  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
htmltable(border=""1"" )
