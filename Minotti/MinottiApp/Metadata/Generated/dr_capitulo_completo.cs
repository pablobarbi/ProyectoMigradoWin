...
{
    public class dr_capitulo_completo : IDataWindowMetadata
    {
        public string DataObject => "dr_capitulo_completo";
...
ORDER BY 1,2,3";
        ...
        public string SrdRaw => @"$PBExportHeader$dr_capitulo_completo.srd
release 10.5;
datawindow(units=0 timer_interval=0 color=16777215 processing=0 HTMLDW=no print.printername="""" print.documentname="""" print.orientation = 0 print.margin.left = 110 print.margin.right = 110 print.margin.top = 96 print.margin.bottom = 96 print.paper.source = 0 print.paper.size = 0 print.canusedefaultprinter=yes print.prompt=no print.buttons=no print.preview.buttons=no print.cliptext=no print.overrideprintjob=no print.collate=yes print.preview.outline=yes hidegrayline=no )
header(height=156 color=""81324524"" )
...
text(band=header alignment=""2"" text=""REPORTE DE CAPÍTULO COMPLETO CON MEDICAMENTOS"" border=""0"" color=""8388608"" x=""37"" y=""28"" height=""80"" width=""3506"" html.valueishtml=""0""  name=t_2 visible=""1""  font.face=""Arial"" font.height=""-12"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
...
column(band=detail id=14 alignment=""0"" tabsequence=0 border=""0"" color=""0"" x=""2222"" y=""528"" height=""64"" width=""279"" html.valueishtml=""0""  name=medicamento visible=""1"" edit.limit=0 edit.case=any edit.focusrectangle=no edit.autoselect=no  font.face=""Arial"" font.height=""-9"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
htmltable(border=""1"" )
