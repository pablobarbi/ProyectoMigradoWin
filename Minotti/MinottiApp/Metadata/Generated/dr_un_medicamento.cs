...
ORDER BY 1,2,3";
        ...
        public string SrdRaw => @"$PBExportHeader$dr_un_medicamento.srd
release 10.5;
...
text(band=header alignment=""2"" text=""REPORTE DE CAPÍTULO CON UN MEDICAMENTO"" border=""0"" color=""8388608"" x=""37"" y=""28"" height=""80"" width=""3506"" html.valueishtml=""0""  name=t_2 visible=""1""  font.face=""Arial"" font.height=""-12"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
