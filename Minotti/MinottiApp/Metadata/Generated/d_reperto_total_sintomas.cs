...
{
    Nombre = "reperto_total_reperto_total",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_reperto_sintoma",
            ...
            new DataWindowColumn
{
    ...
    TabOrder = 32766,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_capitulo",
    ...
    TabOrder = 32766,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_rubrica",
    ...
    TabOrder = 32766,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica2",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica3",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica4",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica5",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica6",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica7",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica8",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica9",
    ...
    UpdateWhereClause = true,
            ...
            new DataWindowColumn
{
    Nombre = "reperto_total_sin_subrubrica10",
            ...
            new DataWindowColumn
{
 ...
 ORDER BY reperto_total.reperto_sintoma;";
        ...
        public string SrdRaw => @"$PBExportHeader$d_reperto_total_sintomas.srd
release 10.5;
