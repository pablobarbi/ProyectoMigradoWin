...
{
    public class dsto_medicamentos_subrubrica_ph : IDataWindowMetadata
    {
        public string DataObject => "dsto_medicamentos_subrubrica_ph";
            ...
            new DataWindowColumn
{
 ...
 WHERE subrubricacion_med.subrubrica_padre = :padre
   AND subrubricacion_med.subrubrica_hija = :hija";
        ...
        public string SrdRaw => @"$PBExportHeader$dsto_medicamentos_subrubrica_ph.srd
release 7;
...
table(column=(type=decimal(0) update=yes updatewhereclause=yes key=yes name=subrubrica_padre dbname=""subrubricacion_med.subrubrica_padre"" )
 column=(type=decimal(0) update=yes updatewhereclause=yes key=yes name=subrubrica_hija dbname=""subrubricacion_med.subrubrica_hija"" )
 column=(type=char(10) update=yes updatewhereclause=yes key=yes name=medicamento dbname=""subrubricacion_med.medicamento"" )
 column=(type=long update=yes updatewhereclause=yes name=valor dbname=""subrubricacion_med.valor"" )
 ...
 WHERE subrubricacion_med.subrubrica_padre = :padre
   AND subrubricacion_med.subrubrica_hija = :hija
"" update=""subrubricacion_med"" updatewhere=1 updatekeyinplace=no arguments=((""padre"", string),(""hija"", string)) )
...
column(band=detail id=4 alignment=""1"" tabsequence=32766 border=""0"" color=""0"" x=""686"" y=""4"" height=""76"" width=""329"" format=""[general]""  name=valor edit.limit=0 edit.case=any edit.autoselect=yes edit.autohscroll=yes  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
