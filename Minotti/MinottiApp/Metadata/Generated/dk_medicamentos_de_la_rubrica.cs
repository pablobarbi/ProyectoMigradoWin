...
{
    public class dk_medicamentos_de_la_rubrica : IDataWindowMetadata
    {
        public string DataObject => "dk_medicamentos_de_la_rubrica";
...
ORDER BY 3 DESC , 1 ASC";
        ...
        public string SrdRaw => @"$PBExportHeader$dk_medicamentos_de_la_rubrica.srd
release 10.5;
...
table(column=(type=char(10) updatewhereclause=yes name=medicamento dbname=""capitulacion_med.medicamento"" )
 ...
 column=(type=decimal(6) updatewhereclause=yes name=valor dbname=""capitulacion_med.valor"" values=""1	1/2	2/3	3/0	0/"" )
...
SELECT medicamentos.medicamento,
 ...
 WHERE medicamentos.medicamento NOT IN ( SELECT capitulacion_med.medicamento FROM capitulacion_med
                                          WHERE capitulacion_med.capitulo = :capitulo AND capitulacion_med.rubrica = :rubrica )
ORDER BY 3 DESC , 1 ASC"" arguments=((""capitulo"", string),(""rubrica"", string)) )
group(level=1 header.height=0 trailer.height=0 by=(""seleccionado"" ) header.color=""536870912"" trailer.color=""536870912"" )
text(band=header alignment=""2"" text=""Descripcion"" border=""6"" color=""8388608"" x=""457"" y=""12"" height=""64"" width=""1399"" html.valueishtml=""0""  name=descripcion_t visible=""1""  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
text(band=header alignment=""2"" text=""Medicamento"" border=""6"" color=""8388608"" x=""18"" y=""12"" height=""64"" width=""421"" html.valueishtml=""0""  name=medicamento_t visible=""1""  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
text(band=header alignment=""2"" text=""Valor"" border=""6"" color=""8388608"" x=""1879"" y=""12"" height=""64"" width=""210"" html.valueishtml=""0""  name=valor_t visible=""1""  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
