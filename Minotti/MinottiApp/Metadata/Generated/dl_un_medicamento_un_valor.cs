...
ORDER BY 1,2,3";
        ...
        public string SrdRaw => @"$PBExportHeader$dl_un_medicamento_un_valor.srd
release 10.5;
...
text(band=header alignment=""2"" text=""REPORTE DE CAPÍTULO CON UN MEDICAMENTO CON UN VALOR"" border=""0"" color=""0"" x=""32"" y=""308"" height=""80"" width=""3259"" html.valueishtml=""0""  name=t_2 visible=""1""  font.face=""Arial"" font.height=""-12"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
...
line(band=footer x1=""18"" y1=""4"" x2=""3040"" y2=""4""  name=l_2 visible=""1"" pen.style=""0"" pen.width=""5"" pen.color=""0""  background.mode=""2"" background.color=""16777215"" )
compute(band=footer alignment=""1"" expression=""'Pag. ' + page() + ' de ' + pageCount()""border=""0"" color=""0"" x=""2176"" y=""16"" height=""64"" width=""855"" format=""[general]"" html.valueishtml=""0""  name=page_1 visible=""1""  font.face=""Arial"" font.height=""-9"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
