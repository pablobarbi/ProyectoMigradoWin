            ...
            new DataWindowColumn
{
  ...
  FROM rubricas";
        ...
        public string SrdRaw => @"$PBExportHeader$d_agregar_rubricas.srd
release 7;
...
table(column=(type=char(255) updatewhereclause=yes name=nombre dbname=""rubricas.nombre"" )
 retrieve=""SELECT rubricas.nombre
  FROM rubricas
"" )
text(band=detail alignment=""1"" text=""Rubrica:"" border=""0"" color=""8388608"" x=""46"" y=""24"" height=""64"" width=""247""  name=nombre_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
column(band=detail id=1 alignment=""0"" tabsequence=10 border=""5"" color=""0"" x=""50"" y=""108"" height=""184"" width=""2309"" format=""[general]""  name=nombre edit.limit=255 edit.case=upper edit.focusrectangle=no edit.autoselect=no edit.nilisnull=yes edit.autovscroll=yes edit.vscrollbar=yes  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""2"" background.color=""16777215"" )
htmltable(border=""1"" )
