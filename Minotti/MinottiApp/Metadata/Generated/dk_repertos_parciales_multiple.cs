...
{
    public class dk_repertos_parciales_multiple : IDataWindowMetadata
    {
        public string DataObject => "dk_repertos_parciales_multiple";
            ...
            new DataWindowColumn
{
  ...
  FROM reperto_parcial,
       reperto_total
 WHERE reperto_total.reperto_total IN ( :repertos )
   AND reperto_total.reperto_parcial = reperto_parcial.reperto_parcial";
        ...
        public string SrdRaw => @"$PBExportHeader$dk_repertos_parciales_multiple.srd
release 7;
...
table(column=(type=decimal(0) update=yes updatewhereclause=yes key=yes identity=yes name=reperto_parcial dbname=""reperto_parcial.reperto_parcial"" )
 ...
 WHERE reperto_total.reperto_total IN ( :repertos )
   AND reperto_total.reperto_parcial = reperto_parcial.reperto_parcial
"" update=""reperto_parcial"" updatewhere=1 updatekeyinplace=no arguments=((""repertos"", string)) )
...
text(band=header alignment=""2"" text=""Síntomas (clickee en ~""incluir~"" si quiere que el síntoma forme parte de la repertorización)"" border=""0"" color=""8388608"" x=""14"" y=""4"" height=""72"" width=""3483""  name=t_2  font.face=""Arial"" font.height=""-11"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
...
text(band=header alignment=""2"" text=""Incluir"" border=""6"" color=""8388608"" x=""3278"" y=""92"" height=""68"" width=""215""  name=t_1  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
...
column(band=detail id=14 alignment=""2"" tabsequence=10 border=""0"" color=""0"" x=""3278"" y=""8"" height=""68"" width=""215"" format=""[general]""  name=seleccionado checkbox.text="""" checkbox.on=""S"" checkbox.off=""N"" checkbox.scale=no checkbox.threed=yes  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
htmltable(border=""1"" )
