...
{
    public class dk_reperto_total_tabla_med : IDataWindowMetadata
    {
            ...
            new DataWindowColumn
{
    ...
    UpdateWhereClause = true,
        ...
        // PB: table.retrieve
        public string Sql => @"SELECT reperto_total_med.reperto_total,
  ...
  FROM reperto_total_med";
        ...
        public string SrdRaw => @"$PBExportHeader$dk_reperto_total_tabla_med.srd
release 10.5;
