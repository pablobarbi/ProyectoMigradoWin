            ...
            new DataWindowColumn
{
 ...
 WHERE dba.acc_operaciones_x_modulo.modulo = :modulo";
        ...
        public string SrdRaw => @"$PBExportHeader$dk_operaciones_x_modulo.srd
release 5;
...
text(band=header alignment=""2"" text=""Sub Módulo""border=""2"" color=""8388608"" x=""1527"" y=""16"" height=""65"" width=""897""  name=submodulo_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
...
column(band=detail id=3 alignment=""0"" tabsequence=20 border=""6"" color=""0"" x=""1527"" y=""16"" height=""73"" width=""897"" format=""[general]""  name=submodulo edit.limit=0 edit.case=any edit.focusrectangle=no edit.autoselect=no  font.face=""Arial"" font.height=""-9"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
";
    }
}
