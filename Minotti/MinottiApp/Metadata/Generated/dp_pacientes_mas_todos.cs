...
{
    public class dp_pacientes_mas_todos : IDataWindowMetadata
    {
        public string DataObject => "dp_pacientes_mas_todos";
            ...
            new DataWindowColumn
{
  ...
  FROM pacientes";
        ...
        public string SrdRaw => @"$PBExportHeader$dp_pacientes_mas_todos.srd
release 7;
...
column(band=detail id=1 alignment=""1"" tabsequence=10 border=""5"" color=""0"" x=""325"" y=""28"" height=""76"" width=""1504"" format=""[general]""  name=paciente dddw.name=dw_pacientes_mas_todos dddw.displaycolumn=nombre dddw.datacolumn=paciente dddw.percentwidth=0 dddw.lines=6 dddw.limit=0 dddw.allowedit=no dddw.useasborder=yes dddw.case=any dddw.nilisnull=yes dddw.vscrollbar=yes  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""2"" background.color=""16777215"" )
htmltable(border=""1"" )
