...
{
    public class dr_operaciones_por_perfil : IDataWindowMetadata
    {
        public string DataObject => "dr_operaciones_por_perfil";
            ...
            new DataWindowColumn
{
 ...
 ORDER BY dba.acc_perfiles.nombre,
        ...
        public string SrdRaw => @"$PBExportHeader$dr_operaciones_por_perfil.srd
release 5;
...
group(level=1 header.height=109 trailer.height=109 by=(""perfil"" ) newpage=yes header.color=""536870912"" trailer.color=""536870912"" )
group(level=2 header.height=193 trailer.height=1 by=(""perfil"" , ""modulo"" ) header.color=""536870912"" trailer.color=""536870912"" )
compute(band=header.1 alignment=""2"" expression=""'Perfíl: ' + nombre_perfil + ' - ( ' + perfil + ' )'""border=""0"" color=""0"" x=""28"" y=""12"" height=""85"" width=""2858"" format=""[general]""  font.face=""Arial"" font.height=""-12"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" font.underline=""1"" background.mode=""1"" background.color=""536870912"" )
text(band=header.2 alignment=""2"" text=""Nombre""border=""0"" color=""8388608"" x=""385"" y=""112"" height=""73"" width=""1299""  name=nombre_operacion_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
text(band=header.2 alignment=""2"" text=""Alta""border=""0"" color=""8388608"" x=""1710"" y=""112"" height=""73"" width=""371""  name=alta_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
line(band=header.2 x1=""23"" y1=""176"" x2=""2871"" y2=""176"" pen.style=""0"" pen.width=""5"" pen.color=""0""  background.mode=""2"" background.color=""16777215"" )
text(band=header.2 alignment=""2"" text=""Modificación""border=""0"" color=""8388608"" x=""2515"" y=""112"" height=""73"" width=""371""  name=modificacion_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
text(band=header.2 alignment=""2"" text=""Baja""border=""0"" color=""8388608"" x=""2113"" y=""112"" height=""73"" width=""371""  name=baja_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
text(band=header.2 alignment=""2"" text=""Operación""border=""0"" color=""8388608"" x=""28"" y=""112"" height=""73"" width=""330""  name=operacion_t  font.face=""Arial"" font.height=""-10"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
compute(band=header.2 alignment=""2"" expression=""'Módulo: ' + nombre_modulo + ' - ( ' + modulo + ' )'""border=""0"" color=""0"" x=""28"" y=""8"" height=""85"" width=""2858"" format=""[general]""  name=mod  font.face=""Arial"" font.height=""-11"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
column(band=detail id=6 alignment=""2"" tabsequence=32766 border=""0"" color=""0"" x=""28"" y=""4"" height=""65"" width=""330"" format=""[general]""  name=operacion edit.limit=0 edit.case=any edit.autoselect=yes  font.face=""Arial"" font.height=""-10"" font.weight=""400""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""536870912"" )
