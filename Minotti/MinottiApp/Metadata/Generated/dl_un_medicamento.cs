...
{
    public class dl_un_medicamento : IDataWindowMetadata
    {
        public string DataObject => "dl_un_medicamento";
...
ORDER BY 1,2,3";
        ...
        public string SrdRaw => @"$PBExportHeader$dl_un_medicamento.srd
release 10.5;
...
UNION
  SELECT cap.capitulo_nombre,
   ...
   WHERE cap.capitulo = :capitulo
     ...
     AND cm.medicamento = :medicamento
ORDER BY 1,2,3
"" arguments=((""capitulo"", string),(""medicamento"", string)) )
text(band=header alignment=""2"" text=""REPORTE DE CAPÍTULO CON UN MEDICAMENTO"" border=""0"" color=""0"" x=""37"" y=""304"" height=""80"" width=""3506"" html.valueishtml=""0""  name=t_2 visible=""1""  font.face=""Arial"" font.height=""-12"" font.weight=""700""  font.family=""2"" font.pitch=""2"" font.charset=""0"" background.mode=""1"" background.color=""553648127"" )
