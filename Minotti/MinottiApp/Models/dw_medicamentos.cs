...
namespace Minotti
{
    // Migrado desde PowerBuilder DataWindow: dw_medicamentos.srd
    // Mantiene el nombre original del objeto DataWindow.
    public class dw_medicamentos
    {
        // Consulta original detectada desde el SRD (puede estar vacía si el objeto es sólo de update)
        public const string Sql = @"SELECT medicamentos.medicamento   FROM medicamentos  ORDER BY medicamentos.medicamento";
