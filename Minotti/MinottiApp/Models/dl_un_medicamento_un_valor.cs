...
namespace Minotti
{
    // Migrado desde PowerBuilder DataWindow: dl_un_medicamento_un_valor.srd
    // Mantiene el nombre original del objeto DataWindow.
    public class dl_un_medicamento_un_valor
    {
...
cm.medicamento = :medicamento      AND
cm.valor = :valor 
UNION   
...
cap.subrubrica09_nombre,  
cap.subrubrica10_nombre,    
cm.valor     FROM capitulaciones_matriz cap           , subrubricacion_med cm
WHERE cap.capitulo = :capitulo      AND 
