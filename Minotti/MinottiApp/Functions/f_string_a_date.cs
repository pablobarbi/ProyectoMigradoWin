...
{
    /// <summary>
    /// Migración de PowerBuilder: f_string_a_date.srf
    /// Firma PB típica: global function date f_string_a_date (string fecha)
    /// En C# devolvemos DateTime? para poder representar NULL (SetNull) de PB.
    /// </summary>
    public static class f_string_a_date
    {
        /// <summary>
        ...
        /// </summary>
        public static DateTime? fstring_a_date(string? fecha)
        {
